        ...
        AnimationTimer timer = new AnimationTimer() {
            ...
            public void handle(long l) {
                ...
                if (!portalList.isEmpty() && bomberman.getX()/32 == portalList.get(0).getX()/32 && bomberman.getY()/32 == portalList.get(0).getY()/32){
                    ...
                    Boss minvo1 = new Boss(10 , 5 , Sprite.minvo_right1.getFxImage());
                    enemyList.add(minvo1);
                    entities.add(minvo1);

                    Enemy ballommap2 = new Oneal(21,3,Sprite.oneal_right1.getFxImage( ));
                    enemyList.add(ballommap2);
                    entities.add(ballommap2);
